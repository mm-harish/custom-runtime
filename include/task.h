...
struct alignas(64) Task {
    alignas(64) std::atomic<int32_t> remainingInputs{0}; ///< Number of inputs this task is waiting for.
    ...
    bool lastProducer{false};                            ///< Flag indicating if this is the last producer for a join.
    bool expectLastProducer{false};                      ///< Flag indicating if the task expects a last producer optimization.
